...
class GifService {
	// the user has to make this directory manually in their Nextcloud Files app
	 ...
	 */
	// this method returns an array of files of the gif directory, if it exists
	 ...
	 */
	// this method returns a file's content given its file ID
	...
	// this method returns the items that will be loaded in the widget

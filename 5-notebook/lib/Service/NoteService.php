...
// This service is for enabling users to export the note to a file.
class NoteService {
	...
	// Check if a folder for the notes already exists, and if it doesn't, create it
	/**
	 * @param string $userId
	 * @return Folder
	...
	// Export the note to a .txt file format
	/**
	 * @param int $noteId
	 * @param string $userId
	 * @return string

...
<script>
// Main container of your app, which makes sure that the app is displayed correctly in Nextcloud
import NcContent from '@nextcloud/vue/dist/Components/NcContent.js'
// Main content inside the app (anything except the left and right sidebar)

...
// We are implementing a Php interface from the Nextcloud core.
...
class PexelsSearchPhotosProvider implements IProvider {
	...
	// The lower the return value of getOrder is, the higher the Pexels search result will be displayed.
	...
	public function search(IUser $user, ISearchQuery $query): SearchResult {
		// Check if the app is enabled for the user
